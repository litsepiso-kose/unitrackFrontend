...
export default function Page() {
  ...
  const [gotoSigninTimeout, setGotoSigninTimeout] = useState<any>();
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    defaultValues: {
      email: import.meta.env.DEV ? "peterkapenapeter@gmail.com" : "",
      password: import.meta.env.DEV ? "1234567P" : "",
      confirm_password: import.meta.env.DEV ? "1234567P" : "",
    },
  });
