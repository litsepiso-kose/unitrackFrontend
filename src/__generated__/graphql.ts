...
export type GetUserApplicationsQuery = { __typename?: 'Query', getUserApplications: Array<{ __typename?: 'ApplicationDataOutput', name: string, id: string, description: string, type: number, deadline: string, courses?: Array<string> | null, applyLink: string, messages: Array<string>, succeeded: boolean }> };
